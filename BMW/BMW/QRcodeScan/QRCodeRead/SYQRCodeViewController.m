...
-(void)initData
{
    ...
    kReaderViewWidth = 200;
    kReaderViewHeight = 200;
}
-(void)initLeftItem
{
...
- (void)initTitleView
{
    ...
    UILabel * titleLab =  [[UILabel alloc] initWithFrame:CGRectMake(50, 28, kDeviceWidth - 100, 20)];
...
- (void)createBackBtn
{
    ...
    [btn setFrame:CGRectMake(20, 22, 35, 35)];
    [btn setImage:[UIImage imageNamed:@"icon_fanhui_sm.png"] forState:UIControlStateNormal];
...
//        return CGRectMake(kLineMinY / KDeviceHeight, ((KDeviceHeight - asize.width) / 2.0) / kDeviceWidth, asize.height / KDeviceHeight, asize.width / kDeviceWidth);
//    }
...
- (void)setOverlayPickerView
{
    ...
    //图片按钮
    UIView * view = [[UIView alloc]initWithFrame:CGRectMake(CGRectGetMinX(labIntroudction.frame) + ((CGRectGetWidth(labIntroudction.frame) - 50)/2), CGRectGetMaxY(labIntroudction.frame) + 15, 50, 50)];
    ...
    UIButton * imageBtn = [[UIButton alloc]initWithFrame:CGRectMake(CGRectGetMinX(labIntroudction.frame) + ((CGRectGetWidth(labIntroudction.frame) - 32)/2), CGRectGetMaxY(labIntroudction.frame) + 15 + 9, 32, 32)];
    [imageBtn setImage:[UIImage imageNamed:@"tupian.png"] forState:UIControlStateNormal];
    [imageBtn addTarget:self action:@selector(processTupianBtn) forControlEvents:UIControlEventTouchUpInside];
...
#pragma mark -- Action --
-(void)processTupianBtn
{
    
    UIImagePickerController *picker = [[UIImagePickerController alloc] init];
    //[picker.navigationBar setTintColor:[UIColor blueColor]];
    [picker.navigationBar setTintColor:self.view.tintColor];
...
-(void)getURLWithImage:(UIImage *)img{
    ...
    if (result) {
        ...
        if (self.SYQRCodeSuncessBlock) {
            self.SYQRCodeSuncessBlock (self,contents);
        }
        /*

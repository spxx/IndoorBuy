...
+ (NSString *)randomPaaWithgoodsName:(NSString *)goodsName amount:(NSString *)amount{
...
//@"http://bmapi.cncoral.com/api/order/allinpaynotify.html"
                         @"http://indoorbuyapi.indoorbuy.com/api/order/allinpaynotify.html"
                         ,@"receiveUrl",
...
//                         @"3", @"language",
                         ...
                         //通联分配给商户的ID
                         //正式完税
//                         @"109020201512095", @"merchantId",
                         //非完税
                         @"109020201512094", @"merchantId",
                         //测试商户号
...
//                         @"840", @"orderCurrency",
                         ...
                         //商品名称[NSString stringWithFormat:@"商品购买_%@",goodsName]
                         @"帮麦网", @"productName",
...
//    NSString *jsonS = [TYTools dataJsonWithDic:mdic];
//    [paaStr setString:[TYTools JSONDataStringTranslation:[NSString stringWithFormat:@"{\"inputCharset\":\"1\",\"receiveUrl\":\"http://bmapi.cncoral.com/api/order/allinpaynotify.html\",\"version\":\"v1.0\",\"signType\":\"0\",\"merchantId\":\"109020201512094\",\"orderNo\":%@,\"orderAmount\":\"1\",\"orderCurrency\":\"0\",\"orderDatetime\":%@,\"productName\":\"帮麦网\",\"payType\":\"27\",\"signMsg\":%@}",mdic[@"orderNo"],mdic[@"orderDatetime"],signMsg.uppercaseString]]];
    
//    [paaStr setString:[NSString stringWithFormat:@"{\"inputCharset\":\"1\",\"receiveUrl\":\"http:\\/\\/bmapi.cncoral.com\\/api\\/order\\/allinpaynotify.html\",\"version\":\"v1.0\",\"signType\":\"0\",\"merchantId\":\"109020201512094\",\"orderNo\":%@,\"orderAmount\":\"1\",\"orderCurrency\":\"0\",\"orderDatetime\":%@,\"productName\":\"帮麦网\",\"payType\":\"27\",\"signMsg\":%@}",mdic[@"orderNo"],mdic[@"orderDatetime"],signMsg.uppercaseString]];
